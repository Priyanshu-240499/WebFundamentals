...
form.addEventListener('submit', (e) => {
  e.preventDefault();//to prevent the default action of submit button
...
let acceptData = function () {
  data['text'] = input.value;//adding property to data object 
  console.log(data);
  readPosts();
};
...
let readPosts = function () {// red part is string intrepolation using ${} in ``
  posts.innerHTML += ` <div>  
    <p>${data.text}</p>
    <span class="options">
